 ...
 */
function SidebarCreateBoardModal({ refreshPageAfterCreateBoard }) {
  const { control, register, handleSubmit, reset, formState: { errors } } = useForm({
    defaultValues: {
      title: '',
      description: '',
      type: BOARD_TYPES.PUBLIC // Mặc định là Public
    }
  })
  ...
  const submitCreateNewBoard = (data) => {
    // Xử lí lỗi thừa khoảng trắng ở đầu và cuối của title và description
    const validaData = {
      ...data,
    ...
    createNewBoardAPI(validaData).then(() => {
      // Reset lại form sau khi tạo board thành công
      reset()
      // Đóng Modal
      handleCloseModal()
      // fetch api boards mới để cập nhật lại danh sách boards
      refreshPageAfterCreateBoard()
    })
